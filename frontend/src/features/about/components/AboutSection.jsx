...
export default function AboutSection() {
  ...
  const bio      = about?.bio      || 'Full-stack web developer focused on building clean, scalable, and user-friendly web applications. Passionate about turning complex problems into efficient digital solutions.';
  ...
  return (
    <section className="min-h-[calc(100vh-5rem)] flex flex-col justify-between py-8 gap-8">
      ...
      <SectionFooter
        ...
        title="About Me"
        tagline="Who I am."
        description={about?.headline || "I'm passionate about building clean, scalable web applications and converting complex challenges into seamless, efficient, and user-centric digital solutions."}
      />
